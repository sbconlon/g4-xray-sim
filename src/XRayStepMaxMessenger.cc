...
XRayStepMaxMessenger::XRayStepMaxMessenger(XRayStepMax* stepM)
:pStepMax(stepM)
{ 
...
XRayStepMaxMessenger::~XRayStepMaxMessenger()
{
  delete StepMaxCmd;
}
...
void XRayStepMaxMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
