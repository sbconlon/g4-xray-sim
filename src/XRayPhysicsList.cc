...
XRayPhysicsList::XRayPhysicsList() : G4VModularPhysicsList()
{
  pMessenger = new XRayPhysicsListMessenger(this); 
   
  // EM physics
  G4LossTableManager::Instance()->SetVerbose(1);
      
  defaultCutValue = 0.*mm;
...
XRayPhysicsList::~XRayPhysicsList()
{
...
void XRayPhysicsList::ConstructParticle()
{
  // pseudo-particles
...
void XRayPhysicsList::ConstructProcess()
{
  AddTransportation();
...
void XRayPhysicsList::AddStepMax()
{
  // Step limitation seen as a process
  XRayStepMax* stepMaxProcess = new XRayStepMax();
...
void XRayPhysicsList::AddPhysicsList(const G4String& name)
{
  if (verboseLevel>-1) {
...
void XRayPhysicsList::SetCutForGamma(G4double cut)
{
  cutForGamma = cut;
...
void XRayPhysicsList::SetCutForElectron(G4double cut)
{
  cutForElectron = cut;
...
void XRayPhysicsList::SetCutForPositron(G4double cut)
{
  cutForPositron = cut;
...
void XRayPhysicsList::SetCutForProton(G4double cut)
{
  cutForProton = cut;
